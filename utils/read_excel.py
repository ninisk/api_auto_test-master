...
def read_excel():
    ...
    # file_path = os.path.abspath(get_file_path.get_root_path() + '\\' + 'testdata\\testdata.xlsx')
    # 文件位置
...
def get_xls():
    cls = []
    # file_path = os.path.abspath(os.path.abspath(os.path.join(os.getcwd(), ".."))+'\\' + 'testdata\\testdata.xlsx')
    # 文件位置
    file_path = r'C:\Users\56462\Desktop\api_auto_test-master\testdata\testdata.xlsx'
    # print(file_path)
    excel_file = xlrd.open_workbook(file_path)
